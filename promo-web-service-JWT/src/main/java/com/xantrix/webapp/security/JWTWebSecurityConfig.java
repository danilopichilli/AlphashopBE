...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public JWTWebSecurityConfig(JwtUnAuthorizedResponseAuthenticationEntryPoint jwtUnAuthorizedResponseAuthenticationEntryPoint, UserDetailsService userDetailsService, JwtTokenAuthorizationOncePerRequestFilter jwtAuthenticationTokenFilter, PasswordEncoderConfig passwordEncoderConfig) {
